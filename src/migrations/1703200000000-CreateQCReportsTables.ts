...
export class CreateQCReportsTables1703200000000 implements MigrationInterface {
  name = 'CreateQCReportsTables1703200000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Add qcStatus column to transactions table
